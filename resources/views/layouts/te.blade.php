		...
		<header id="header">
			...
			<nav id="nav">
				<ul id="menu-header" class="menu">
					<li id="menu-item-475" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-223 current_page_item menu-item-475"><a href="https://www.ucc.edu.gh" aria-current="page">Ucc</a></li>
                    @guest
			...
			<nav id="mobile-nav">
				<ul class="menu">
					<li class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-223 current_page_item menu-item-475"><a href="https://www.ucc.edu.gh" aria-current="page">Ucc</a></li>
                    @guest
                        <li id="menu-item-475" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-223 current_page_item menu-item-475">
                                <a class="nav-link" href="{{ route('login') }}" aria-current="page">Login</a>
                        </li>   
