	 ...
	 <section class="newsfeed">
	  <div class="container">
		  ...
		  <div class="tr-post">
		   <div class="entry-header">
		    <div class="entry-thumbnail">
		     <a href="user/{{$user->id}}"><img class="img-fluid" src="storage/files/profile_pics/{{$user->image}}" alt="Image"></a>
		    </div><!-- /entry-thumbnail -->
	       </div><!-- /entry-header -->
		   <div class="post-content">
		    <div class="author-post text-center">
		     <a href="user/{{$user->id}}"><img class="img-fluid rounded-circle" src="storage/files/profile_pics/{{$user->image}}" alt="Image"></a>
		    </div><!-- /author -->
			<div class="card-content">
			 <h4>{!!$user->title!!} {!! $user->first_name!!} {!! $user->last_name!!}({!!$user->name!!})</h4>
		     <span>{{$user->status}}</span>
			</div>
			 <a href="user/{{$user->id}}" class="kafe-btn kafe-btn-mint-small full-width"> View profile
			 </a>		  
		   </div><!-- /.post-content -->									
		  </div><!-- /.tr-post -->	
	     </div><!-- /.tr-post -->	
	   ...
	   <div class="row">
	    ...
	    <div class="col-lg-4">
		 <a href="photo_explore.html#myModal" data-toggle="modal">
          ...
          <div class="col-md-4 modal-meta">
           <div class="modal-meta-top">
            ...
            <div class="img-poster clearfix">
             <a href="photo_explore.html"><img class="img-responsive img-circle" src="assets/img/users/18.jpg" alt="Image"/></a>
             <strong><a href="photo_explore.html">Benjamin</a></strong>
             <span>12 minutes ago</span><br/>
		     <a href="photo_explore.html" class="kafe kafe-btn-mint-small"><i class="fa fa-check-square"></i> Following</a>
            </div><!--/ img-poster -->
            ...
            <ul class="img-comment-list">
             <li>
              ...
              <div class="comment-text">
               <strong><a href="photo_explore.html">Anthony McCartney</a></strong>
             ...
             <li>
              ...
              <div class="comment-text">
               <strong><a href="photo_explore.html">Vanessa Wells</a></strong>
             ...
             <li>
              ...
              <div class="comment-text">
               <strong><a href="photo_explore.html">Sean Coleman</a></strong>
             ...
             <li>
              ...
              <div class="comment-text">
               <strong><a href="photo_explore.html">Anna Morgan</a></strong>
               <p class="">Hello this is a test comment.</p> <span class="date sub-text">on December 5th, 2016</span>
              </div>
             </li><!--/ li -->
             <li>
              ...
              <div class="comment-text">
               <strong><a href="photo_explore.html">Allison Fowler</a></strong>
               <p class="">Hello this is a test comment.</p> <span class="date sub-text">on December 5th, 2016</span>
              </div>
             </li><!--/ li -->
            </ul><!--/ comment-list -->
            ...
            <div class="modal-meta-bottom">
			 <ul>
			  <li><a class="modal-like" href="photo_explore.html#"><i class="fa fa-heart"></i></a><span class="modal-one"> 786,286</span> | 
			      <a class="modal-comment" href="photo_explore.html#"><i class="fa fa-comments"></i></a><span> 786,286</span> </li>
			  <li>
			   <span class="thumb-xs">
